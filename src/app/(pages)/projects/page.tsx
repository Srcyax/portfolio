            ...
            <div className="flex flex-col items-center">
                ...
                <div className="grid grid-cols-3 grid-rows-none max-[766px]:grid-cols-1 max-[925px]:grid-cols-2">
                    <CardProject 
                        ...
                        technologies={
                            ["nextjs", "tailwindcss", "javascript", "react"]
                        }
                    />
                    <CardProject 
                        image="https://w7.pngwing.com/pngs/399/491/png-transparent-quiz-computer-icons-general-knowledge-question-others-blue-game-angle.png" 
                        title = "Quizz Hub"
